    ...
    return (
        <div className='my-10'>
            ...
            >
                ...
                <SwiperSlide>
                    <div className='flex flex-col md:min-h-[850px] items-center justify-center' style={{ background: `url('https://i.ibb.co/XLqWtZS/1.jpg')` }}>
                ...
                <SwiperSlide>
                    <div className='flex flex-col md:min-h-[850px] items-center justify-center' style={{ background: `url('https://i.ibb.co/KF4tyPk/2.jpg')` }}>
                        <div className='md:bg-green-100 text-center p-10 rounded-xl space-y-4'>
                ...
                <SwiperSlide>
                    <div className='flex flex-col md:min-h-[850px] items-center justify-center' style={{ background: `url('https://i.ibb.co/Qp4c969/3.jpg')` }}>
                        <div className='md:bg-green-100 text-center p-10 rounded-xl space-y-4'>
                ...
                <SwiperSlide>
                    <div className='flex flex-col md:min-h-[850px] items-center justify-center' style={{ background: `url('https://i.ibb.co/ypnSYwf/4.jpg')` }}>
                        <div className='md:bg-green-100 text-center p-10 rounded-xl space-y-4'>
